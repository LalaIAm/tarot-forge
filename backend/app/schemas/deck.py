...
class CardGalleryItem(BaseModel):
    """Card fields plus image URL for gallery display."""
...
class DeckDetailOut(BaseModel):
    """Deck with progress and optional cards for gallery."""
    ...
    total_cards: int = 0
    cards: list[CardGalleryItem] | None = None
